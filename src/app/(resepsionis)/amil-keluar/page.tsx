...
export default function AmilKeluarPage() {
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-3xl font-bold text-emerald-800 dark:text-emerald-500 font-serif">Amil Keluar</h1>
        <p className="text-muted-foreground font-sans">Catat dan kelola data amil yang keluar kantor secara real-time.</p>
      </div>
